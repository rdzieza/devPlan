...
public class MainView extends SherlockFragmentActivity implements ActionBar.TabListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		actionBar.addTab(actionBar.newTab().setText("time table").setTabListener(this));
